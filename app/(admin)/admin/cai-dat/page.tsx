...
function ToggleSwitch({
    ...
    const colorMap = {
        ...
        blue: checked ? "bg-primary" : "bg-gray-200",
    };
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <Button
                    onClick={handleSave}
                    disabled={isSaving}
                    className="bg-primary text-white hover:bg-primary/90 rounded-xl h-11 px-8 shadow-sm shadow-primary/20"
                >
                    {isSaving ? (
                            ...
                            >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        rows={3}
                                        className="w-full rounded-xl border border-gray-200 p-3 text-sm text-gray-800 placeholder:text-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                            ...
                            >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        rows={2}
                                        className="w-full rounded-xl border border-gray-200 p-3 text-sm text-gray-800 placeholder:text-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                                        placeholder="6v6, giải đấu, tournament, esports..."
                                    />
                                ...
                                <div className="mt-4 p-4 bg-gray-50 rounded-xl border border-gray-100">
                                    ...
                                    <div className="bg-white rounded-lg p-4 border border-gray-200 max-w-xl">
                                        <div className="text-xs text-emerald-700 mb-1 truncate">{form.siteUrl || "https://6v6.vn"}</div>
                            ...
                            >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        rows={4}
                                        className="w-full rounded-xl border border-gray-200 p-3 text-sm text-gray-800 font-mono placeholder:text-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                                        placeholder={"User-agent: *\nAllow: /\nDisallow: /admin/\n\nSitemap: https://6v6.vn/sitemap.xml"}
                                    />
                                </div>
                            </SettingsCard>
                        </motion.div>
                        ...
                        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                            ...
                            >
                                <div className="space-y-4">
                                    {[
                                        { key: "socialFacebook", label: "Facebook", icon: Globe, placeholder: "https://facebook.com/6v6vn", color: "text-blue-600" },
                                        { key: "socialYoutube", label: "Youtube", icon: Globe, placeholder: "https://youtube.com/@6v6vn", color: "text-red-500" },
                                        { key: "socialTiktok", label: "TikTok", icon: Hash, placeholder: "https://tiktok.com/@6v6vn", color: "text-gray-900" },
                                        { key: "socialInstagram", label: "Instagram", icon: Globe, placeholder: "https://instagram.com/6v6vn", color: "text-pink-500" },
                                        { key: "socialTwitter", label: "Twitter / X", icon: Globe, placeholder: "https://twitter.com/6v6vn", color: "text-sky-500" },
                                        { key: "socialDiscord", label: "Discord", icon: MessageCircle, placeholder: "https://discord.gg/6v6vn", color: "text-indigo-500" },
                                        { key: "socialTelegram", label: "Telegram", icon: Send, placeholder: "https://t.me/6v6vn", color: "text-sky-400" },
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1 space-y-1">
                                            ...
                                            <Input value={form.contactEmail} onChange={(e) => updateField("contactEmail", e.target.value)} className="h-10 rounded-lg" placeholder="contact@6v6.vn" />
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                            ...
                            >
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        rows={5}
                                        className="w-full rounded-xl border border-gray-200 p-3 text-sm font-mono text-gray-800 placeholder:text-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-gray-50"
