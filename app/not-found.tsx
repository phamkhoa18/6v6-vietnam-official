        ...
        <div className="min-h-screen flex items-center justify-center bg-[#FAFBFC] px-4">
            <div className="text-center max-w-sm">
                ...
                <div className="relative mb-6">
                    <div className="text-[120px] sm:text-[140px] font-extrabold leading-none tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-efb-red via-[#B91C1C] to-efb-gold select-none">
                        404
                    </div>
                    <div className="absolute inset-0 text-[120px] sm:text-[140px] font-extrabold leading-none tracking-tighter text-red-100/40 blur-md select-none pointer-events-none">
                        404
                    </div>
                </div>
                ...
                <div className="flex items-center justify-center gap-2.5">
                    <Link
                        href="/"
                        className="inline-flex items-center gap-1.5 px-4 py-2 text-[13px] font-medium text-white bg-gradient-to-r from-efb-red to-[#B91C1C] rounded-lg hover:opacity-90 transition-opacity shadow-sm"
                    >
