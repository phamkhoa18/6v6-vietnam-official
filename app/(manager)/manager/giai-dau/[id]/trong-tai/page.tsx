    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Button className="bg-efb-red text-white hover:bg-efb-red/90 font-semibold text-sm h-10 px-5 rounded-lg">
                    ...
                    {referees.map((ref) => (
                        <div key={ref.id} className="flex items-center gap-4 px-5 py-4 hover:bg-gray-50/50 transition-colors group">
                            <div className="w-9 h-9 rounded-lg bg-red-50 flex items-center justify-center">
                                <ShieldCheck className="w-4 h-4 text-efb-red" />
                            </div>
                            ...
                            <button className="w-7 h-7 rounded hover:bg-gray-100 flex items-center justify-center text-efb-text-muted hover:text-efb-red transition-colors" title="Copy token">
